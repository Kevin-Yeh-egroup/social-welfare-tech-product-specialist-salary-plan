...
- Artifact: social welfare tech product specialist salary positioning report
- Public boundary: de-identified salary-positioning case report
- Search posture: noindex, nofollow, noarchive
- GitHub repo: https://github.com/Kevin-Yeh-egroup/social-welfare-tech-product-specialist-salary-plan
...
- Deployment lookup: use `vercel inspect` or `vercel ls` for the current production deployment ID
